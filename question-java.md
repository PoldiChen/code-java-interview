...
#### 201. 二叉树的各种方法？计算深度、遍历。code

#### 202. 内存溢出实例？hprof文件分析？？？《深入理解Java虚拟机》code
...
#### 203. CyclicBarrier和CountDownLatch的区别？
...
#### 204. wait()和notify()/notifyAll()在放弃对象监视器时有什么区别？
...
#### 214. 什么是优先级队列（PriorityQueue）？源码？？？code
...
#### 216. Enumeration接口和Iterator接口的区别？code？？？
...
#### 217. Java类可以定义析构函数（finalization）吗？？？

#### 218. finalize()方法什么时候被调用？
